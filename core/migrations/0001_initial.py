# Generated by Django 6.0.5 on 2026-06-01 02:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Новая', 'Новая'), ('Идет обучение', 'Идет обучение'), ('Обучение завершено', 'Обучение завершено')], default='Новая', max_length=50, verbose_name='Статус')),
